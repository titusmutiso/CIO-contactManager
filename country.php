...
$mainpage = 'customers';
$page = 'customers';
$company_query  = "select * from sp_company  WHERE country_id='$get_id'";
$company_res    = mysqli_query($connection,$company_query);
$company_count  =   mysqli_num_rows($company_res);

//choose Country name
$country_query  = "select * from sp_countries WHERE id = '$get_id'";
  ...
  <div class="page-content">
    ...
    <div class="panel panel-default">
      <div class="panel-heading">
        <h6 class="panel-title"><?php echo $company_count ?> Companies from <?php echo $country_names ?></h6>
      </div>
