/**
 * Created by SparkWorld on 3/4/2017.
 */
/*******************************************************************************
...
$(document).ready(function() {
    ...
    $(document).on('click', ".email-invoice", function(e) {
        ...
        var invoiceId = 'action=email_invoice&id='+$(this).attr('data-invoice-id')+'&email='+$(this).attr('data-email'); //build a post data structure
